...
<div class="container">
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading" style="background: #ffda6a">
                ...
                <form id="loginform" class="form-horizontal" role="form" method="post" action="loginValidar.php">
                    ...
                    <div style="margin-top:10px" class="form-group">
                        ...
                        <div class="col-sm-12 controls">
                            <button id="btn-signup" type="submit" class="btn btn-warning" name="usuarioVerificar"><i class="icon-hand-right"></i> &nbsp Acceder</button>
    ...
    <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <form id="signupform" class="form-horizontal" role="form" action="aplicarMovimiento.php" method="post">
